...
namespace Universitario.Controllers
{
    ...
    {
        private readonly UniversitarioContext _context;

        public EstudiantesController(UniversitarioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEstudiante,Nombre,Apellido,Estatus,Carrera")] Estudiantes estudiantes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstudiante,Nombre,Apellido,Estatus,Carrera")] Estudiantes estudiantes)
        {
